...
import { Day5FirstHundredEmail } from './_templates/day5-first-hundred.tsx';
...
serve(async (req) => {
  ...
  try {
    ...
    const html = await renderAsync(
      React.createElement(Day5FirstHundredEmail, {
        affiliateName: name,
    ...
    await resend.emails.send({
      ...
      to: [email],
      subject: '💰 Day 5: Your First $100 in Commissions',
      html,
    });
