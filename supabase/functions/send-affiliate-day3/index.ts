...
import { Day3FacelessKitEmail } from './_templates/day3-faceless-kit.tsx';
...
serve(async (req) => {
  ...
  try {
    ...
    const html = await renderAsync(
      React.createElement(Day3FacelessKitEmail, {
        affiliateName: name,
    ...
    await resend.emails.send({
      ...
      to: [email],
      subject: '📱 Day 3: Faceless Content Kit (No Camera Needed)',
      html,
    });
